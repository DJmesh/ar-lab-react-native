...
export const MOCK_AR_MODELS: ARModel[] = [
  {
    id: 'model-math',
    name: 'Maçãs Mágicas (Vermelhas & Verdes)',
    type: 'geometry',
    filePath: 'assets/models/math/apple_red.glb',
    scale: [0.2, 0.2, 0.2],
    rotation: [0, 0, 0],
    position: [0, -0.2, -0.5],
    description: 'Maçãs 3D espalhadas no ambiente para o jogo pedagógico de organização!',
    educationalTags: ['matemática pré-zinho', 'classificação', 'senso de organização'],
  },
  {
    id: 'model-geo',
    name: 'Globo Terrestre Interativo',
    type: 'geometry',
    filePath: 'assets/models/geography/earth_globe.glb',
    scale: [0.3, 0.3, 0.3],
    rotation: [0, 15, 0],
    position: [0, 0, -0.6],
    description: 'Globo 3D do Planeta Terra com gincana de caça aos continentes!',
    educationalTags: ['geografia infantil', 'continentes', 'gincana global'],
  },
  {
    id: 'model-port',
    name: 'Letra A 3D + Abelha Mágica',
    type: 'geometry',
    filePath: 'assets/models/portuguese/letter_a_bee.glb',
  ...
  },
  {
    ...
    name: 'Molécula H₂O',
    type: 'molecule',
    filePath: 'assets/models/chemistry/h2o_molecule.glb',
    scale: [0.1, 0.1, 0.1],
    rotation: [0, 0, 0],
    position: [0, 0, -0.5],
